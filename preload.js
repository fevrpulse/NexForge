...
contextBridge.exposeInMainWorld('nexforge', {
  ...
  getGameBoostPrefs: () => ipcRenderer.invoke('get-game-boost-prefs'),
  setGameBoostPrefs: (prefs) => ipcRenderer.invoke('set-game-boost-prefs', prefs),
  getDesktopPrefs: () => ipcRenderer.invoke('get-desktop-prefs'),
  setDesktopPrefs: (prefs) => ipcRenderer.invoke('set-desktop-prefs', prefs),
