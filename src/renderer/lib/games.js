...
export const GAME_MODES = {
  ...
  'CS2':                   [{icon:'🔫',name:'Competitive 5v5',desc:'Official ranked format in player-hosted lobbies.',details:'MR12 competitive rules with full buy economy. MMR adjusts based on round differential and performance.',server:'Player-hosted lobby'},{icon:'⚡',name:'Wingman 2v2',desc:'Tight map 2v2 competitive format.',details:'Small-map duels with faster rounds. Great for aim training and duo queue practice.',server:'Player-hosted lobby'},{icon:'💥',name:'Deathmatch',desc:'Free-for-all warmup queue.',details:'No MMR impact. Spawn instantly and practice aim before ranked sessions.',server:'Player-hosted lobby'},{icon:'🏆',name:'Tournament',desc:'Bracket-style CS2 event.',details:'5v5 bracket with map veto. Prize pool events run on weekends.',server:'Player-hosted lobby'}],
...
export const DEFAULT_MODES = [
  {icon:'⚔',name:'Ranked 1v1',desc:'Compete head-to-head for MMR.',details:'Standard 1v1 ranked queue with full stat tracking.',server:'Player-hosted lobby'},
  {icon:'👥',name:'Ranked 5v5',desc:'Full team competitive queue.',details:'Team-based ranked with role assignment and MMR tracking.',server:'Player-hosted lobby'},
  {icon:'🛡',name:'Unranked',desc:'Casual practice with no rank pressure.',details:'Same rules as ranked without MMR impact. Good for learning.',server:'Player-hosted lobby'},
